...
echo "⚠️  Isso vai SOBRESCREVER os dados atuais do PocketBase."
...
cd "$APP_DIR"
docker compose restart pocketbase 2>/dev/null || true
ok "Restauração concluída. PocketBase reiniciado."
